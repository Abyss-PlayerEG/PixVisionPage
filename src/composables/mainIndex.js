...
export const useNum7zAnimation = (expandedFAQs) => {
    ...
    const mockNum7zQA = [
        {
            id: 1,
            question: '「像素视觉」是什么？',
            answer: 'Pixel Vision 一个面向摄影与数字艺术爱好者的公开分享平台，由「第三维度」团队打造。' +
                '在这里上传作品、浏览创作、互动评论，享受纯粹的视觉交流。',
            answer2: '无论是摄影还是数字绘画，注册后即可申请成为创作者，所有作品经过AI和人工审核，确保内容合规与质量。',
        },
        {
            id: 2,
            ...
            answer2: '上传作品时请确保内容真实、原创且无版权问题，提交后经审核通过即可公开展示。',
        },
    ]
    ...
    const mockNum7zFAQ = [
        ...
        },
        {
            ...
            answer: '可以。在作品详情页或个人作品管理中，可修改标题、替换图片、更改原创/转载标注，也可随时删除作品。',
        },
        {
            id: 5,
            question: '忘记密码怎么办？',
        ...
        },
        {
            id: 6,
            question: '能和其他用户互动吗？',
            answer: '当然！你可以「点赞」和「收藏」喜欢的作品，也可以在作品发布「评论」。未来我们还会继续加入更多互动功能。',
        },
        {
            id: 7,
